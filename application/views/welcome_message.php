...
<html>
	...
	<body>
		<nav class="navbar navbar-expand-lg navbar-light bg-light mk-navbar">
		...
		<div class="jumbotron jumbotron-fluid text-center mk-jumbotron">
			<div class="container">
				<h1 class="display-4">Halo Sam</h1>
				<p class="lead">02 Pengenalan MVC bag 1</p>
			</div>
		</div>
		<div class="text-center mk-main">
			<h1>
				Halaman Utama
			</h1>
